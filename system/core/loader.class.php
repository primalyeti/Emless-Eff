...
class Loader
{
	...
	{
		return $this->load_class_in_folder( "library", $class, $args, $include_only );
	}

	public function api( $class, $args = array(), $include_only = false )
	{
		return $this->load_class_in_folder( "apis", $class, $args, $include_only );
	}

	protected function load_class_in_folder( $searchFolder, $class, $args, $include_only )
	{
		...
		{
			$path = ROOT . DS . $location . DS . $searchFolder . DS . $class . ".class.php";
